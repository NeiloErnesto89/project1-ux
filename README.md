...
# *[Eco Friendly Fellow- a webpage for environmental hacks ](https://neiloernesto89.github.io/project1-ux/)*

# *Design brief:*
 One or two paragraphs providing an overview of your project.
 
 
>The goal of this project is to create a UX-centric website. We were expected to use the skills we have learned to date, particularly HTML and CSS, to achieve this goal.


## **My project is a website intended for people with interest in environment and how they can learn more about it **
...
I provide some statistics, such as on the footers, using a Bootstrap icon as a link to a seperate web page, that I feel would capture the imagination and then offer up some of my own hacks/tips. Also, for example, on the Tips sections, I give a simple statement, offering some advice as well as providing a link with more detailed information.
