...
### *My personal project goal, with the design guideline in mind, was to create a website intended for people with an interest in the environment, who want to learn more on this increasingly pertinent topic and how they can personally do more about reducing their carbon footprint and be more enviromentally aware*
...
With regards to UX, my overarching goal was to provide very simple website, that the User can navigate easily whilst digesting the information that has been presented, in a smooth and effcient manner. I wanted to keep the design very simple, minimum text, easy to navigate, using some eye catching color (green, for example, is prominent and is often associated with eco-friendliness e.g. the [Green party](https://www.greenparty.ie/) or [Greenpeace](https://www.greenpeace.org/international/) ). I also use some photos that I took myself, which I found to be visually very stimulating, but without taking too much away from the content. This balance was suprisingly tricky to achieve at times but I feel I found it. 

My ideal user would be someone who is interested in learning more about the environment and would retain some of the facts and tips that I have laid out. I tried to keep the site uniform across platforms as to retain to it's simplicity and responsiveness.
...
The option is also there for users who would be interested in reaching out to me for information, questions or a potential project. I find that those who are enviromentally inclined are very much willing to get involved but often the most difficult part is starting out or finding someone to reach out to. So I aimed to provide a personal touch and platform for a connection via the About and Contact section. 

### *UX using Wireframes*

Underneath are my intial wireframes, that I designed on my own using Balsamiq, focusing this time, on the desktop approach: 
...
Originally, I planned to use statistics (pie charts, bar charts  etc.) however I later settled on icons using [Font Awesome](https://fontawesome.com/start) (with links and a short piece of text) to keep the information as simple as possible and as astheically uniform as possible. 
...
I decdied upon having a website with 6 seperate pages, all having a generally identical layout including a navbar, main container jumbotron/content etc and footer. For each separate page the content was adapted to suit the pages needs. I used the Bootstrap [cover template](https://getbootstrap.com/docs/4.0/examples/cover/) to wrap the pages contents in  so the height would adjust automatically, depending on the Users viewport.  

I used a simple Boostrap navbar to give the user a go-to section at the top of the page to orientate themselves easily. The navbar is consistent throughout the site. Once the site moves away from the desktop format, the hamburger icon comes into use. 
...
I also surround the title *Tips* and the insuing card section in transparent/coloured container to give it some contrast again the vivid imagine in the background. I used this concept on all the main sections of all the pages (with differing sizes due to the different content) to provide some visual contrast. 
